...
test('accepts the exact separated golden and post-reset v138 snapshot control', async () => {
  ...
  const latest = {
    ...
    seal: { key: `${prefix}/SCV_TIMESTAMPED_SNAPSHOT_CATALOG_SEAL.json`, sha256: 'bddd904ee1f3a71218501bc768d5de6e9d0d6dab21161be9bff0a0cc523da86a' },
    ...
    restore_receipts: {
      pre_v138_omar_reset: {
        key: `${prefix}/receipts/pre-v138-omar-reset-20260902T054849Z.json`,
        sha256: PRE_RESTORE_RECEIPT_SHA256
      },
      current_post_v138_omar_reset: {
        key: `${prefix}/receipts/current-post-v138-omar-reset-20260902T054852Z.json`,
