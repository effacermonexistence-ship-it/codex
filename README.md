...
the global Codex and Claude instructions. The active SCV Instagram v140 custody
record is documented in `docs/scv-instagram-v140-custody.md` (v138 and v139 records
are retained alongside it); older records are
